package de.uzl.lied.mtbexporter.jobs.mdr.samply;
...
import de.uzl.lied.mtbexporter.settings.SamplyMdrSettings;

public class SamplyMdrAttributes {

    public static String getAttributes(SamplyMdrSettings mdr, String targetProfile, String key)
